...
public class TooltipHelper {
	...
	private static void buildFoodEffectTooltip(@NotNull List<Component> tooltip, List<ConsumeEffect> effects, float tickRate, MutableComponent component) {
		...
		if (!modifiers.isEmpty()) {
			...
			tooltip.add(component.withStyle(ChatFormatting.DARK_PURPLE));
